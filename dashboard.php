...
<?php
$sql1 ="SELECT Studentusn from newstudents ";
...
?>
                                            ...
                                            <span class="name">Student Information</span>
...
?>
                                            ...
                                            <span class="name">Faculty Information</span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        ...
                                        <?php
$sql3="SELECT  distinct Usn from  Result ";
