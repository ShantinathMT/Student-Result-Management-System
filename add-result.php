                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Result Creation</h2>
...
<label for="default" class="col-sm-2 control-label">Usn</label>
 <div class="col-sm-10">
 <select name="Usn" class="form-control clid" id="Usn" onChange="getStudent(this.value);" required="required">
<option value="">Select Usn</option>
<?php $sql = "SELECT * from newstudents";
$query = $dbh->prepare($sql);
$query->execute();
...
{   ?>
<option value="<?php echo htmlentities($result->Studentusn); ?>"><?php echo htmlentities($result->Studentusn); ?></option>
...
<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="Sub_Code" class="form-control" id="default" placeholder="" required="required">
                                                        </div>
                                                    </div>
                                                    
													<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Test1</label>
                                                        <div class="col-sm-10">
 <input type="text" name="Test1" class="form-control" id="default" placeholder="" required="required">
                                                        </div>
                                                    </div>
													
													<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Test2</label>
                                                        <div class="col-sm-10">
 <input type="text" name="Test2" class="form-control" id="default" placeholder="" required="required">
                                                        </div>
                                                    </div>
													
													<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Test3</label>
                                                        <div class="col-sm-10">
 <input type="text" name="Test3" class="form-control" id="default" placeholder="" required="required">
                                                        </div>
                                                    </div>
