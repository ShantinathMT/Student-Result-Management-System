...
<html lang="en">
    <head>
        ...
        <title>Student Internal Assesment Analysis System</title>
                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Student Internal Assesment Analysis System</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Usn" placeholder="" autocomplete="off" name="Usn">
                                	</div>
