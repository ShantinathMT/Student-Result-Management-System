...
$sql="INSERT INTO newtsudents(Studentusn,StudentName,RollNo,StudentSem,StudentDivision,StudentEmail,Gender,DOB) VALUES(:Studentusn,:StudentName,:RollNo,:StudentSem,:StudentDivision,:StudentEmail,:Gender,:DOB)";
